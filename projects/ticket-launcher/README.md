...
1. イベント名、5分刻みの発売日時、販売 URL を手動登録する
2. 発売 10分前、5分前、3分前、1分前にローカル通知する
...
- [x] Xcode をインストール
- [x] SwiftUI プロジェクトを作成
- [x] 5分刻みの日本語日時入力・端末内保存・10/5/3/1分前通知・発売待機画面を実装
- [x] 前面待機中の画面点灯維持と、発売時刻のSafari自動表示を実装
- [x] シミュレータと実機で主要受け入れテスト
- [x] 5分刻み日時入力と4段階通知への改修後にiPhone実機で再確認
