...
3. Reuse `assets/` without substituting font-drawn or newly generated logos. Keep all opponent circles at the same visible diameter. Read `assets/SOURCE.md` before redistribution.
4. Run `render_magic_chart.py` and verify that the PNG is exactly 2880 × 1620, matches the JSON, and retains the approved white-background sample style.
